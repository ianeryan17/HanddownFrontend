...
const InterestTags = ({ navigateTo }) => {
  ...
  const handleInterestTags = async () => {
    ...
    console.log("handleInterestTags called");

    try {
      console.log("userid:", userId)
      // console.log("Sending body request: ", requestBody); // Log to verify the data

      const response = await fetch(`${config.baseUrl}/onboarding/profile-interests/${userId}?interests=${tagString}`, {
        method: 'POST',
        headers: {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.background}>
        ...
        <View style={styles.logo}>
          <Text style={styles.logoText}>Add your interests!</Text>
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.topHalfContent}>
            <Text style={styles.descriptionText}>Adding what you're interested in acquiring will allow us to more accurately connect you with other users and find offers that fit your needs.</Text>
